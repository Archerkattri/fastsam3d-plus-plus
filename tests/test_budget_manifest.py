"""Budget-manifest integration for the Fast-SAM3D++ SLaT solver seam."""
...
def test_slat_manifest_records_actual_decisions_and_costs():
    solver = Euler().enable_hicache(interval=3, first_enhance=0, max_horizon=1)
    ...
    assert report["identity"]["stage"] == "slat-flow"
